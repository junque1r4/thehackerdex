...
use thehackerdex::{
    ...
    wallet_analysis::{
        historical_context_aggregation, HistoricalWalletContext, TransactionDetails,
    },
};
use regex::Regex;
...
// Removed local definitions of is_known_program_id, should_exclude_counterparty, 
// and historical_context_aggregation. They are now imported from 
// thehackerdex::wallet_analysis module.
